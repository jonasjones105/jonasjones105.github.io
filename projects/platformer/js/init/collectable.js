(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max,400, 350)
        collectable.create(type.grace,300,500)
        collectable.create(type.kennedi,600,400)
        collectable.create(type.kennedi,500,100)
